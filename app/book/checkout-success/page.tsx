    ...
    <div className="space-y-4 sm:space-y-6 md:space-y-8">
      ...
      <div className="bg-white dark:bg-elegant-darkCard rounded-xl shadow-lg p-4 sm:p-6 md:p-8 transition-colors duration-300 max-w-none">
        <div className="text-center">
          <div className="w-16 h-16 mx-auto mb-6 sm:mb-8 bg-green-100 dark:bg-green-900/20 rounded-full flex items-center justify-center">
            <svg
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-elegant-lightText dark:text-elegant-darkText mb-8 sm:mb-10">
            購入ありがとうございます！
          </h2>
