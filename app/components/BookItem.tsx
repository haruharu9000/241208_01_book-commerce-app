          ...
          <div className="flex flex-row justify-between items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              {isPurchased ? (
                ...
                book.price > 0 && (
                  <span className="inline-block bg-elegant-lightMuted dark:bg-elegant-darkMuted text-white dark:text-elegant-darkText text-xs px-2 sm:px-3 py-1 sm:py-1.5 rounded-full hover:bg-elegant-lightText dark:hover:bg-elegant-darkText transition-colors duration-200">
                    購入する
                  </span>
                )
              )}
